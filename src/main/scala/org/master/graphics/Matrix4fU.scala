...
class OrthoProjectionMatrix(val width: Float, val height: Float, val zNear: Float, val zFar: Float, var zoomCf: Float1U = Float1U(1.0f))
...
object Matrix4fU {
  ...
  def orthographical(pm: OrthoProjectionMatrix): OrthoProjectionMatrix = {
    ...
    pm.setOrtho(pm.zoomCf * left, pm.zoomCf * right, pm.zoomCf * bottom, pm.zoomCf * top, pm.zNear, pm.zFar)
    pm
  }
...
case class Int1U(var v1: Int = 0) extends Uniform { override def set(location: Int = this.location): Unit = glUniform1i(location, v1) }
case class Int2U(var v1: Int = 0, var v2: Int = 0) extends Uniform { override def set(location: Int = this.location): Unit = glUniform2i(location, v1, v2) }
case class Int3U(var v1: Int = 0, var v2: Int = 0, var v3: Int = 0) extends Uniform { override def set(location: Int = this.location): Unit = glUniform3i(location, v1, v2, v3) }
case class Int4U(var v1: Int = 0, var v2: Int = 0, var v3: Int = 0, var v4: Int = 0) extends Uniform { override def set(location: Int = this.location): Unit = glUniform4i(location, v1, v2, v3, v4) }

case class Float1U(var v1: Float = 0) extends Uniform {
  override def set(location: Int = this.location): Unit = glUniform1f(location, v1)
  def *(float: Float): Float = v1 * float
}
case class Float2U(var v1: Float = 0, var v2: Float = 0) extends Uniform { override def set(location: Int = this.location): Unit = glUniform2f(location, v1, v2) }
case class Float3U(var v1: Float = 0, var v2: Float = 0, var v3: Float = 0) extends Uniform {
...
case class Float4U(var v1: Float = 0, var v2: Float = 0, var v3: Float = 0, var v4: Float = 0) extends Uniform { override def set(location: Int = this.location): Unit = glUniform4f(location, v1, v2, v3, v4) }